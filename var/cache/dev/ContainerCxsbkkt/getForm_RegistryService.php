...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\FicheType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\FicheType']) ? $this->services['AppBundle\Form\FicheType'] : $this->services['AppBundle\Form\FicheType'] = new \AppBundle\Form\FicheType()) && false ?: '_'};
}, 'AppBundle\\Form\\ManagerType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ManagerType']) ? $this->services['AppBundle\Form\ManagerType'] : $this->services['AppBundle\Form\ManagerType'] = new \AppBundle\Form\ManagerType()) && false ?: '_'};
}, 'AppBundle\\Form\\ProjetType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ProjetType']) ? $this->services['AppBundle\Form\ProjetType'] : $this->services['AppBundle\Form\ProjetType'] = new \AppBundle\Form\ProjetType()) && false ?: '_'};
