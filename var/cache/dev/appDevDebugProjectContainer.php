...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c' => 'get1667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865cService',
            '2_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c' => 'get2667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865cService',
        ...
        $this->privates = array(
            '1_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c' => true,
            '2_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c']) ? $this->services['1_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c'] : $this->get1667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865cService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c']) ? $this->services['2_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c'] : $this->get2667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865cService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'lp3-dbb', 'user' => 'root', 'password' => 'ini01', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/Camille/PlatformBundle/Resources/config/doctrine') => 'Camille\\PlatformBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Camille\\PlatformBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('CamillePlatformBundle' => 'Camille\\PlatformBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Camille/PlatformBundle/Resources/views'), 'CamillePlatform');
        $instance->addPath(($this->targetDirs[3].'/src/Camille/AppBundle/Resources/views'), 'CamilleApp');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dbeb8888b81bf0751b53199611a4600ab10d9d34');
    }
    ...
    /**
     * Gets the '1_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get1667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865cService()
    {
        return $this->services['1_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get2667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865cService()
    {
        return $this->services['2_667278728054af33b7eb6aadca43680f183d33144b2ca0b3bc78b512caed865c'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('bWDoL3XK5v', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0wTRbbYMi2', 0, 'RFT3oa+g9ifdeyD0K3p8JR', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JZsP18y-Hj', 0, 'RFT3oa+g9ifdeyD0K3p8JR', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KVmRaNIoWL', 0, 'RFT3oa+g9ifdeyD0K3p8JR', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a36f27c82f988.91071323');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'CamillePlatformBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Camille/PlatformBundle'),
                    'namespace' => 'Camille\\PlatformBundle',
                ),
                'CamilleAppBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Camille/AppBundle'),
                    'namespace' => 'Camille\\AppBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CamillePlatformBundle' => 'Camille\\PlatformBundle\\CamillePlatformBundle',
                'CamilleAppBundle' => 'Camille\\AppBundle\\CamilleAppBundle',
            ...
            'secret' => 'dbeb8888b81bf0751b53199611a4600ab10d9d34',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'dbeb8888b81bf0751b53199611a4600ab10d9d34',
