...
use Camille\PlatformBundle\Entity\Projet;
...
class ProjetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $projets = $em->getRepository('CamillePlatformBundle:Projet')->findAll();
    ...
    {
        $projet = new Projet();
        $form = $this->createForm('Camille\PlatformBundle\Form\ProjetType', $projet);
    ...
    {
        $deleteForm = $this->createDeleteForm($projet);
        $editForm = $this->createForm('Camille\PlatformBundle\Form\ProjetType', $projet);
